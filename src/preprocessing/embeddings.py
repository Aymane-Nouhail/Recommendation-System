...
class ItemEmbeddingGenerator:
    ...
    def create_item_embeddings(self, 
                              ...
                              batch_size: int = 32) -> Tuple[np.ndarray, Dict[str, int], Dict[int, str]]:
        """
...
def load_embeddings(embeddings_path: str, 
                   mappings_path: Optional[str] = None) -> Tuple[np.ndarray, Optional[Dict], Optional[Dict]]:
    """
...
def compute_item_embeddings(input_path: str,
                           output_path: str,
